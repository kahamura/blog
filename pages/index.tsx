      ...
      <div className="px-1">
        <Link href="/articles">
          <a className="flex no-underline">
            <div className="bg-rose-100 dark:bg-white w-16 h-16 rounded-md flex place-items-center place-content-center">
              <Image
        ...
        <Link href="/diaries">
          <a className="flex mt-6 no-underline">
            <div className="bg-rose-100 dark:bg-white rounded-md w-16 h-16 flex place-items-center place-content-center">
              <Image
